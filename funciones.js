const campo_texto =
  document.querySelector("#texto-encriptado"); /* datos ingresados textarea1 */
const campo_mensaje =
...
function btnEncriptar() {
  ...
  alert("Se procedera a Encriptar Texto");
...
function btnDesencriptar() {
  ...
  alert("Se procedera a Desencriptar Texto ingresado...");
